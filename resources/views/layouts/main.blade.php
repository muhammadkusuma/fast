    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-5 px-4 space-y-2">
                ...
                <a href="#" class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg group hover:bg-blue-50 hover:text-primary transition-colors">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <header class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shadow-sm">
                <div class="flex items-center">
                    <button @click="sidebarOpen = true" class="text-gray-500 focus:outline-none lg:hidden hover:text-primary">
